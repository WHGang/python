...
- [Convolutional Neural Networks (CNNs / ConvNets)](#convolutional-neural-networks-cnns--convnets)
  - [Architecture Overview](#architecture-overview)
  - [Layers used to build ConvNets](#layers-used-to-build-convnets)
...
回顾：主要讲全连接网络的特点，不适合进行图片的学习，参数量太大。
